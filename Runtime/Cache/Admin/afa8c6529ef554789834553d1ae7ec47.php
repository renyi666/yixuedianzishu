...
<body>
	...
	<div class="cf">
		...
		<div class="search-form fl ">
			<div class="sleft">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="text" name="title" class="search-input" value="<?php echo I('title');?>" placeholder="请输入isbn或图书名">
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><img src="<?php echo (get_image_url($vo["image_l"])); ?>" style="width: 50px;"></td>
			<td><?php echo ($vo["title"]); ?></td>
			<td><?php echo (time_format($vo["create_time"],'Y/m/d')); ?></td>
			<td><?php echo (time_format($vo["pubdate"],'Y/m/d')); ?></td>
			<td><?php echo ($vo["count"]); ?>条</td>
			<td>
				<a class="" href="<?php echo U('edit',array('id'=>$vo['id']));?>">编辑</a>
				<a class="ajax-get confirm" href="<?php echo U('del',array('id'=>$vo['id']));?>">删除</a>
			</td>
	...
	<script src="/dzs/Public/static/thinkbox/jquery.thinkbox.js"></script>
